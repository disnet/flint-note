...
**Right Sidebar: Your AI Assistant**
Flint's AI assistant is designed to enhance your thinking, not replace it. Ask it to find connections between notes, help organize your thoughts, or surface relevant information from your knowledge base. The AI understands your notes and can reference them directly using the same `[[note name]]` syntax you use.

## The AI That Assists, Never Replaces
...
- Get in the way of simply writing things down

Your thinking is uniquely yours. The goal is to amplify your cognitive abilities, not replace them.
...
The best thinking tools get out of your way. They provide enough structure to prevent chaos while maintaining the flexibility your mind needs to make unexpected connections.

**Frictionless Capture**
A good thinking tool doesn't interfere with having thoughts. When an idea strikes, you should be able to capture it immediately without thinking about where it goes or how it fits. Organization can come later.

**Gradual Structure**
Real thinking is messy. Ideas don't emerge fully formed with perfect categorization. Flint lets you start messy and add structure as patterns emerge. Your understanding of your notes will evolve over time.

**Data Ownership**
Your thoughts belong to you. Flint stores your notes as plain markdown files on your computer. You can back them up, sync them, share them, or move them to another system anytime.

## Your Next Steps

Start small: create a daily note and begin capturing your thoughts. Link to ideas that don't exist yet. Chat with the AI when you need help organizing or connecting ideas. Let the system grow organically as your thinking develops.

Flint is about creating an external thinking system that enhances your ability to develop ideas, make connections, and build knowledge over time.
