<script lang="ts">
  ...
  import AutomergeWebpageReader from './AutomergeWebpageReader.svelte';
  ...
  let readerComponent = $state<AutomergeWebpageReader | undefined>(undefined);
