<script lang="ts">
  ...
  import AutomergeDeckOperatorSelector from './AutomergeDeckOperatorSelector.svelte';
  import AutomergeDeckValueInput from './AutomergeDeckValueInput.svelte';
...
<div class="filter-row">
  <div class="filter-controls">
    ...
    <AutomergeDeckOperatorSelector
      operators={availableOperators}
      selectedOperator={currentOperator}
      onSelect={handleOperatorChange}
    />

    <AutomergeDeckValueInput
