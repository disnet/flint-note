<script lang="ts">
  ...
  import AutomergePdfReader from './AutomergePdfReader.svelte';
  import AutomergePdfOutline from './AutomergePdfOutline.svelte';
  import AutomergePdfHighlights from './AutomergePdfHighlights.svelte';
  ...
  let reader = $state<AutomergePdfReader | null>(null);
