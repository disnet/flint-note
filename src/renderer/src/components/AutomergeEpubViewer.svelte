<script lang="ts">
  ...
  import AutomergeEpubReader from './AutomergeEpubReader.svelte';
  import AutomergeEpubToc from './AutomergeEpubToc.svelte';
  import AutomergeEpubHighlights from './AutomergeEpubHighlights.svelte';
  ...
  let reader = $state<AutomergeEpubReader | null>(null);
    ...
    >
      ...
      {#if showToc}
        <aside class="sidebar toc-panel">
          <AutomergeEpubToc {toc} onNavigate={handleTocNavigate} />
        </aside>
      {/if}
