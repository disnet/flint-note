<script lang="ts">
  import type { ColumnFormat, AutomergeFieldType } from '../lib/automerge/deck';
  import { getNote } from '../lib/automerge/state.svelte';

  interface Props {
    value: unknown;
    fieldType: AutomergeFieldType | 'system' | 'unknown';
    format?: ColumnFormat;
    isTitle?: boolean;
  ...
  // Get note info for a single notelink from Automerge
  ...
  // Get note info for notelinks array from Automerge
