<script lang="ts">
  import type { FilterOperator, AutomergeFieldType } from '../lib/automerge/deck';
  import { EMPTY_FILTER_VALUE } from '../lib/automerge/deck';

  interface Props {
    fieldType: AutomergeFieldType;
...
<div class="value-input">
  {#if fieldType === 'notelink' && !isMultiValue}
    <!-- Single notelink - simple text input for now -->
    <input
      type="text"
      class="text-input"
