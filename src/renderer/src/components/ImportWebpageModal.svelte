<script lang="ts">
  import { importWebpageFromUrl } from '../lib/automerge/webpage-import.svelte';
  ...
  async function handleSubmit(event: Event): Promise<void> {
    ...
    try {
      await importWebpageFromUrl(url.trim());
      onClose();
    } catch (err) {
    ...
    <div class="modal-content">
      ...
      <form class="import-form" onsubmit={handleSubmit}>
        <div class="form-description">
          Enter the URL of a webpage to archive. The page will be saved locally with
