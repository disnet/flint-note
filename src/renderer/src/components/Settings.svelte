...
<div class="settings">
  <div class="settings-content">
    ...
    <section class="settings-section">
      ...
      <p class="section-description">
        Manage custom TypeScript functions that can be reused across AI conversations.
        Create, test, and organize your own function library for common workflows.
      </p>

      <div class="custom-functions-section">
        <div class="functions-info">
          <p>
            Custom functions allow you to create reusable TypeScript code that AI agents
            can call during conversations. This helps streamline repetitive tasks and
            build a library of proven workflows.
          </p>

          <div class="functions-features">
            <h4>Features:</h4>
            <ul>
              <li>TypeScript function definitions with type safety</li>
              <li>Parameter validation and testing interface</li>
              <li>Function library with search and tagging</li>
              <li>Usage analytics and performance tracking</li>
              <li>Import/export functionality for sharing</li>
            </ul>
          </div>

          <div class="functions-note">
            <strong>Note:</strong> Custom functions are scoped per vault and execute in a secure
            sandbox environment with the same API access as regular code evaluation.
          </div>
        </div>
        ...
        <div class="functions-actions">
          <button
            class="btn-primary"
            onclick={() => window.open('custom-functions-manager')}
          >
            <svg
              width="16"
              height="16"
          ...
          <p class="action-description">
            Opens the custom functions manager where you can create, edit, test, and
