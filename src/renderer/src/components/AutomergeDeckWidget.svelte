<script lang="ts">
  ...
  import AutomergeDeckPaginationControls from './AutomergeDeckPaginationControls.svelte';
  import AutomergeDeckToolbar from './AutomergeDeckToolbar.svelte';
  import AutomergeDeckNoteListItem from './AutomergeDeckNoteListItem.svelte';
  import AutomergeDeckPropPickerDialog from './AutomergeDeckPropPickerDialog.svelte';
  import AutomergeDeckFilterPopup from './AutomergeDeckFilterPopup.svelte';
  import AutomergeDeckViewSwitcher from './AutomergeDeckViewSwitcher.svelte';
  ...
  const queryResult = $derived.by(() => {
    ...
    return runAutomergeDeckQuery(effectiveConfig, allNotes, getNoteTypesDict(), {
      offset
    });
  });
...
>
  ...
  <div class="deck-content">
    ...
    {:else}
      ...
      <!-- Pagination Controls -->
      <AutomergeDeckPaginationControls
        {currentPage}
        {totalPages}
        {pageSize}
        {total}
