 ...
 */
export type AutomergeFieldType =
  | 'string'
  | 'number'
  | 'boolean'
  | 'date'
 ...
 */
export interface AutomergeFilterFieldInfo {
  /** Field name */
  name: string;
  /** Display label */
  label: string;
 ...
 */
export const OPERATORS_BY_TYPE: Record<AutomergeFieldType, FilterOperator[]> = {
 ...
 */
export const SYSTEM_FIELDS: AutomergeFilterFieldInfo[] = [
 ...
 */
export function getOperatorsForType(type: AutomergeFieldType): FilterOperator[] {
 ...
 */
export interface AutomergeDeckResultNote {
  id: string;
  title: string;
 ...
 */
export interface AutomergeDeckQueryResult {
  /** Notes matching the query for the current page */
  notes: AutomergeDeckResultNote[];
 ...
 */
export interface AutomergeDeckQueryOptions {
...
/**
 * Convert a Note to AutomergeDeckResultNote
 */
 ...
 */
export interface AutomergeDeckBlock {
