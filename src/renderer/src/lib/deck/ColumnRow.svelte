<script lang="ts">
  import type { ColumnConfig, FilterFieldInfo, ColumnFormat } from './types';
  import { SYSTEM_COLUMNS, getFormatsForType, getFormatLabel } from './types';
  ...
  const systemFieldInfos = $derived<FilterFieldInfo[]>(
